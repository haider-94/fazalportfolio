  ...
  experience: [
    {
      ...
      jd: "I freelance as a Full Stack Eng. for different web and mobile apps. The nature of apps include management systems, personal portfolios, scheduling apps, health care and much more.",
      stacks: [
        "React Native",
        "Ruby on Rails",
        "React",
    ...
    },
    {
      ...
      company: "Nisum",
      jd: "Delivered high-quality, robust production code for a diverse array of projects for clients including Prologis, Harvard Business School, Everytown for Gun Safety, Pratt Institute, Koala Health, Vanderbilt University, The 19th News, and more. Provide leadership within engineering department through close collaboration, knowledge shares, and mentorship.",
      stacks: ["React Native", "JavaScript", "React", "Typescript", "Node", "CI/CD", "Git", "Jira"],
    },
    {
      id: 3,
      ...
      company: "Devsinc",
      jd: "Worked my way from being a fresh Software Engineer all the way upto Team Lead. I worked on in house and live apps including BOON, W9Manager, RunBuddyMobile and couple more.",
      stacks: [
        "Ruby on Rails",
        "React",
        "React Native",
    ...
    },
    {
      ...
      stacks: ["Angular 6", "Firebase", "Node", "Electron", "HTML", "CSS", "CircleCI", "Git"],
    },
  ],
  projects: [
    {
